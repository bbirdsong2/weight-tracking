        ...
        <>
            <Accordion>
                ...
                <AccordionDetails>
                        ...
                        <TableBody>
                            {metrics.map((m) => (
                                <TableRow key={m.name} sx={{ backgroundColor: m.color }}>
                                    <TableCell style={{ color: 'black', padding: '6px 8px' }} scope="row">
                                        {m.name}
                                    </TableCell>
                                    <TableCell style={{ color: 'black', padding: '6px 8px' }}>
                    ...
                    <Button sx={{ margin: 1 }} color="secondary" variant="contained" size="small" onClick={showEdit}>
                        Change
                    </Button>
                    <Button sx={{ margin: 1 }} color="error" variant="contained" size="small" onClick={remove}>
                        Remove
                    </Button>
                </AccordionDetails>
            </Accordion>
