...
export default function DayEntryEdit({ user, entry, setEntry, open, hideEdit, save }) {
    ...
    return (
        <>
            <Dialog fullScreen open={open} onClose={hideEdit}>
                <AppBar sx={{ position: 'relative' }}>
                    <Toolbar>
                        <IconButton edge="start" color="inherit" onClick={hideEdit}>
                            <CloseIcon />
                        </IconButton>
                        <Typography sx={{ ml: 2, flex: 1 }} variant="h6" component="div">
                            {entry.date}
                        </Typography>
                        <Button autoFocus color="inherit" onClick={() => saveEntry()}>
                            Save
                        </Button>
                    </Toolbar>
                </AppBar>
